(function($) {
    var $table = $('div.dm_sql_backup #dm_sql_backup_table');
    ...
    $('div.dm_sql_backup #dm_sql_backup_table input.check_all').click(function(evt){
    ...
    $('div.dm_sql_backup .dm_delete_link').click(function(){
        var $button = $(this);
    ...
    $('div.dm_sql_backup .dm_download_link').click(function(){
        var meta = $(this).metadata();
        window.open(meta.link + '?_file_name=' + meta.file);
    });        
        
    $('div.dm_sql_backup .batch_delete_button').click(function(){
