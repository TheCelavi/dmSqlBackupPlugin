...
echo _tag('th', __('DBMS'));
echo _tag('th', __('Host'));
echo _tag('th', __('Database'));
...
foreach ($files as $file) {
    echo _open('tr');
        ...
        echo _tag('td', $file['dbms']);
        echo _tag('td', $file['host']);
        echo _tag('td', $file['database']);
                ...
                echo _tag('li.sf_admin_action_download', 
                        _tag('a.s16.s16_download.dm_download_link.sf_admin_action', 
                                array('title'=>__('Download this backup'), 'json'=>array(
                                    'link'=>  _link('dmSqlBackupAdmin/download')->getHref(),
                                    'file'=> $file['path']                                       
                                )), __('Download')));
